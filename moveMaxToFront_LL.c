...
////////////////////////////////////////////////////////////////////////
int moveMaxToFront(ListNode **ptrHead) //Version 1
{
	...
	//traverse to find largest element first
	while (temp !=NULL){
		if (temp->item > max){
			max = temp->item;
			cur = temp;
...
int moveMaxToFront(ListNode **ptrHead) //Version 2
{
	ListNode *cur,*prev,*max,*maxPrev;
	max = *ptrHead;
	cur = *ptrHead;
	prev = NULL;
	maxPrev= NULL;
